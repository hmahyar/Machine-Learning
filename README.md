...
#### Project 5: Http-Request responce size Prediction

In this ptoject I try to predict the responce size for Http-Request. for more information go to the FIleSize Folder and read Report.pdf.
